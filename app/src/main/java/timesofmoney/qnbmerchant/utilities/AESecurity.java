...
public class AESecurity {
     ...
     private String iv = "288dca8258b1dd7c";
    ...
    public String encryptString(String _plainText) throws Exception{
           ...
           return encryptDecrypt(_plainText, QNBMerchantApp.getInstance().getKey(), EncryptMode.ENCRYPT, iv);
     }
    ...
    public String  decryptString(String _encryptedText) throws Exception{
          ...
          return encryptDecrypt(_encryptedText, QNBMerchantApp.getInstance().getKey(), EncryptMode.DECRYPT, iv);
     }
